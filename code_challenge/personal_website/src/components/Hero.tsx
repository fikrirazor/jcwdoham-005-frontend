    ...
    >
      <div className=" text-left h-screen flex flex-col justify-center items-center bg-black/30 backdrop-blur-sm">
        <div className="grid grid-cols-2 grid-rows-1">
          {/* Text column - keep left alignment */}
          ...
          {/* Image column - CENTERED with circular styling */}
          <div className="container max-w-screen-2xl mx-auto flex px-5 py-12 items-center justify-center flex-col">
            <img
              className="Photo-Profile rounded-full object-cover w-64 h-64 border-4 border-white"
              src="https://avatars.githubusercontent.com/u/10283205?v=4"
              alt="Profile"
            />
          </div>
        </div>
